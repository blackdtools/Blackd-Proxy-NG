...
#define MyAppName "Blackd Proxy NG"
...
AppId={{39B6E378-A552-42BD-AEF3-59AF3A8E565A}
AppName={#MyAppName}
...
OutputBaseFilename=blackdproxy_ng_installer_{#MyAppVersion}
Compression=lzma
...
Source: "disconnected.wav"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "JwldButn2b.ocx"; DestDir: "{sys}"; Flags: restartreplace uninsneveruninstall sharedfile regserver 
