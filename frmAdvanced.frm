...
Begin VB.Form frmAdvanced 
   ...
   Begin VB.CheckBox chkStopOnGM 
      BackColor       =   &H80000014&
      Caption         =   "Stop on Gamemaster messages"
      Height          =   255
      Left            =   240
      TabIndex        =   37
      Top             =   1560
      Width           =   2655
   End
   Begin JwldButn2b.JeweledButton cmdSet25 
      Height          =   375
      Left            =   1440
      TabIndex        =   36
      Top             =   660
      ...
      MousePointer    =   99
   End
   Begin JwldButn2b.JeweledButton cmdSet0 
      Height          =   375
      Left            =   240
      TabIndex        =   35
      Top             =   660
      ...
      MousePointer    =   99
   End
   Begin JwldButn2b.JeweledButton cmdUpdatePIDs 
      Height          =   255
      Left            =   240
      TabIndex        =   34
      Top             =   1140
   ...
   Begin JwldButn2b.JeweledButton cmdChange 
      ...
      _ExtentX        =   4683
      _ExtentY        =   661
      Caption         =   "Reset Tibia Configuration"
      PictureSize     =   0
      OriginalPicSizeW=   0
      OriginalPicSizeH=   0
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
   ...
   Begin VB.CheckBox chkWantBypass 
      ...
      Width           =   7935
   End
   Begin VB.CommandButton cmdUpdatePIDs2 
      BackColor       =   &H80000018&
      ...
      Width           =   2655
   End
   Begin VB.CommandButton cmdSet252 
      BackColor       =   &H80000018&
      Caption         =   "Restore FPS"
      Height          =   375
      Left            =   1440
      ...
      Width           =   1455
   End
   Begin VB.CommandButton cmdSet02 
      BackColor       =   &H80000018&
      Caption         =   "Set 0 FPS"
      Height          =   375
      Left            =   120
   ...
   Begin VB.CommandButton cmdChange2 
      BackColor       =   &H00C0C0FF&
      Caption         =   "Reset Tibia Version Configuration"
      Height          =   375
      Left            =   240
      Style           =   1  'Graphical
      TabIndex        =   13
