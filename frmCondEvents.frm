...
Begin VB.Form frmCondEvents 
   ...
   Begin JwldButn2b.JeweledButton cmdReloadFiles 
      Height          =   255
      Left            =   1860
      TabIndex        =   38
      Top             =   3120
   ...
   End
   Begin JwldButn2b.JeweledButton cmdLoadEv 
      Height          =   255
      Left            =   960
      TabIndex        =   37
      Top             =   3120
      ...
      BorderColor_Inner=   16777215
   End
   Begin JwldButn2b.JeweledButton cmdSaveEv 
      Height          =   255
      Left            =   120
      TabIndex        =   36
      Top             =   3120
      ...
      BorderColor_Inner=   16777215
   End
   Begin JwldButn2b.JeweledButton cmdModify 
      Height          =   255
      Left            =   5100
      TabIndex        =   35
      Top             =   2760
   ...
   Begin JwldButn2b.JeweledButton cmdDeleteSel 
      ...
      BorderColor_Inner=   16777215
   End
   Begin JwldButn2b.JeweledButton cmdAddEvent 
      Height          =   315
      Left            =   5280
      TabIndex        =   33
      Top             =   4380
   ...
   Begin VB.TextBox txtThing2 
      ...
      Width           =   1515
   End
   Begin VB.CommandButton cmdAddEvent2 
      BackColor       =   &H0000C000&
      Caption         =   "Add conditional"
      Height          =   375
      Left            =   5520
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.ComboBox txtFile 
      ...
      Width           =   2475
   End
   Begin VB.CommandButton cmdSaveEv2 
      BackColor       =   &H0000C000&
      Caption         =   "save"
      Height          =   255
      Left            =   1620
      ...
      Width           =   855
   End
   Begin VB.CommandButton cmdLoadEv2 
      BackColor       =   &H0000C000&
      Caption         =   "load"
      Height          =   195
      Left            =   660
   ...
   Begin VB.CommandButton cmdDeleteSel2 
      ...
      Width           =   1455
   End
   Begin VB.CommandButton cmdReloadFiles2 
      BackColor       =   &H00C0FFFF&
      Caption         =   "refresh"
      Height          =   255
      Left            =   4860
   ...
   Begin VB.Label Label2 
      BackColor       =   &H80000014&
      Caption         =   "List of conditional events :"
      Height          =   255
      Left            =   240
      TabIndex        =   21
      Top             =   600
...
Private Sub cmdDeleteSel_Click()
  ...
  Exit Sub
goterr:
  frmMain.txtPackets.Text = frmMain.txtPackets.Text & vbCrLf & "Function cmdDeleteSel2_Click() - cond - failed : " & Err.Description
  LogOnFile "errors.txt", "Function cmdDeleteSel2_Click() - cond - failed : " & Err.Description
End Sub
...
goterr:
  txtMs.Text = "200"
  TimerConditionTick = 200
  timerCheck.Interval = 200
End Sub
...
Private Sub txtMs2_Change()
  ...
  If lngTick2 < (TimerConditionTick + 200) Then
    lngTick2 = TimerConditionTick + 200
  End If
  TimerConditionTick2 = lngTick2
  Exit Sub
goterr:
  txtMs2.Text = CStr(TimerConditionTick + 200)
  TimerConditionTick2 = TimerConditionTick + 200
End Sub
