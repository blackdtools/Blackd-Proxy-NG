...
Begin VB.Form frmMain 
   ...
   Begin VB.CommandButton cmdChg 
      Caption         =   "Start proxy game connection (after IP changer)"
      Height          =   495
      Left            =   120
      TabIndex        =   42
      Top             =   1680
   ...
   Begin VB.OptionButton TrueServer1 
      BackColor       =   &H80000014&
      Caption         =   "Forward to Tibia Global"
      Height          =   375
      Left            =   120
      TabIndex        =   35
      Top             =   0
...
Private Function InitSounds(thehwnd As Long) As Boolean
  ...
  If bRes = True Then
    ...
    'aqui teste som
    soundErrorLine = "loadingThisSound = App.Path & ""\disconnected.wav"""
    loadingThisSound = App.path & "\disconnected.wav"
    ...
    soundErrorLine = "DirectX_LoadSound loadingThisSound, 5"
    DirectX_LoadSound loadingThisSound, 5
...
If TimerChanger.enabled = True Then
TimerChanger.enabled = True
Else
TimerChanger.enabled = False
End If
End Sub
...
Private Sub Form_Load()
  ...
  If InitSounds(Me.hwnd) = False Then
    SoundIsUsable = False
    If MsgBox("Sorry, " & currentAppName & " got an error while trying to initialize the Directx sound system" & vbCrLf & _
...
lastLoadLine = 660
  ...
  For i = 1 To MAXCLIENTS
    ...
    RuneMakerOptions(i).autoUtamo = RuneMakerOptions_autoUtamo_default
    RuneMakerOptions(i).autotar = RuneMakerOptions_autotar_default
    RuneMakerOptions(i).autoAp = RuneMakerOptions_autoAp_default
    RuneMakerOptions(i).autossa = RuneMakerOptions_autossa_default
    RuneMakerOptions(i).autopmax = RuneMakerOptions_autopmax_default
    RuneMakerOptions(i).autoSdt = RuneMakerOptions_autoSdt_default
    RuneMakerOptions(i).autoDan = RuneMakerOptions_autoDan_default
    RuneMakerOptions(i).autodd = RuneMakerOptions_autodd_default
    RuneMakerOptions(i).autoee = RuneMakerOptions_autoee_default
    RuneMakerOptions(i).autoarme4 = RuneMakerOptions_autoarme4_default
    RuneMakerOptions(i).autoarme5 = RuneMakerOptions_autoarme5_default
    RuneMakerOptions(i).autoarme6 = RuneMakerOptions_autoarme6_default
    RuneMakerOptions(i).autora = RuneMakerOptions_autora_default
    RuneMakerOptions(i).autoda = RuneMakerOptions_autoda_default
    RuneMakerOptions(i).autoxray = RuneMakerOptions_autoxray_default
    RuneMakerOptions(i).autodk = RuneMakerOptions_autodk_default
    RuneMakerOptions(i).autogHur = RuneMakerOptions_autogHur_default
    RuneMakerOptions(i).autoHur = RuneMakerOptions_autoHur_default
    RuneMakerOptions(i).autoPM2 = RuneMakerOptions_autoPM2_default
    RuneMakerOptions(i).autoaim = RuneMakerOptions_autoaim_default
    RuneMakerOptions(i).autoUE = RuneMakerOptions_autoUE_default
    RuneMakerOptions(i).locktrigger = RuneMakerOptions_locktrigger_default
    ...
    RuneMakerOptions(i).autossap = RuneMakerOptions_autossap_default
    RuneMakerOptions(i).autoerg = RuneMakerOptions_autoerg_default
    ...
    RuneMakerOptions(i).cmbleaderText = RuneMakerOptions_cmbleaderText_default
    RuneMakerOptions(i).comboText = RuneMakerOptions_comboText_default
    RuneMakerOptions(i).synccomboText = RuneMakerOptions_synccomboText_default
    RuneMakerOptions(i).cmbtypeText = RuneMakerOptions_cmbtypeText_default
    RuneMakerOptions(i).thirdActionText = RuneMakerOptions_thirdActionText_default
    RuneMakerOptions(i).firstActionMana = RuneMakerOptions_firstActionMana_default
    RuneMakerOptions(i).beeploot = RuneMakerOptions_beeploot_default
    RuneMakerOptions(i).Text2 = RuneMakerOptions_text2_default
    RuneMakerOptions(i).Text3 = RuneMakerOptions_text3_default
    ...
    ' aq tentativa hardcore options:
    HardcoreCheatsOptions(i).Text11 = HardcoreCheatsOptions_Text11_default
    HardcoreCheatsOptions(i).Text10 = HardcoreCheatsOptions_Text10_default
    HardcoreCheatsOptions(i).Text7 = HardcoreCheatsOptions_Text7_default
    HardcoreCheatsOptions(i).Text8 = HardcoreCheatsOptions_Text8_default
    HardcoreCheatsOptions(i).Text2 = HardcoreCheatsOptions_Text2_default
    HardcoreCheatsOptions(i).Text3 = HardcoreCheatsOptions_Text3_default
    HardcoreCheatsOptions(i).Text12 = HardcoreCheatsOptions_Text12_default
    HardcoreCheatsOptions(i).Text3 = HardcoreCheatsOptions_Text3_default
    HardcoreCheatsOptions(i).Text6 = HardcoreCheatsOptions_Text6_default
    HardcoreCheatsOptions(i).Text5 = HardcoreCheatsOptions_Text5_default
    HardcoreCheatsOptions(i).txtExuraVita = HardcoreCheatsOptions_txtExuraVita_default
    HardcoreCheatsOptions(i).txtExuraVita2 = HardcoreCheatsOptions_txtExuraVita2_default
    HardcoreCheatsOptions(i).txtExuraVitaMana2 = HardcoreCheatsOptions_txtExuraVitaMana2_default
    HardcoreCheatsOptions(i).txtExuraVitaMana = HardcoreCheatsOptions_txtExuraVitaMana_default
    HardcoreCheatsOptions(i).txtExuraVita4 = HardcoreCheatsOptions_txtExuraVita4_default
    HardcoreCheatsOptions(i).txtExuraVita3 = HardcoreCheatsOptions_txtExuraVita3_default
    HardcoreCheatsOptions(i).arme = HardcoreCheatsOptions_arme_default
    HardcoreCheatsOptions(i).arme2 = HardcoreCheatsOptions_arme2_default
    HardcoreCheatsOptions(i).arme3 = HardcoreCheatsOptions_arme3_default
    HardcoreCheatsOptions(i).sphi = HardcoreCheatsOptions_sphi_default
    HardcoreCheatsOptions(i).splo = HardcoreCheatsOptions_splo_default
    HardcoreCheatsOptions(i).pmh = HardcoreCheatsOptions_pmh_default
    HardcoreCheatsOptions(i).pth = HardcoreCheatsOptions_pth_default
    ...
    'Set targetScript(i) = New scripting.Dictionary
  ...
  If ((TibiaVersionLong < 710) Or (TibiaVersionLong > highestTibiaVersionLong)) Then
    MsgBox "TibiaVersionLong is holding an unsupported version value (" & CStr(TibiaVersionLong) & ")" & vbCrLf & _
     ...
     "1) close " & currentAppName & vbCrLf & _
     "2) delete settings.ini" & vbCrLf & _
     "3) reopen " & currentAppName
     End
  End If
'loadTibiaDatPath:
'  If configPath = "" Then
...
'  End If
  ...
  'If ((TibiaVersionLong = highestTibiaVersionLong) And (UseRealTibiaDatInLatestTibiaVersion = True)) Then
    If (CurrentTibiaDatDATE = MyErrorDate) Then
       ...
       "Please ensure that you really installed Tibia there! " & currentAppName & " must close now." & vbCrLf & _
...
goterr:
  ...
  MsgBox "Sorry, " & currentAppName & " was not able to complete the loading." & vbCrLf & _
  " Debug mode activated. Please send the following details to daniel@blackdtools.com :" & vbCrLf & _
  " Details:" & vbCrLf & _
  " - " & currentAppName & " Version: " & ProxyVersion & vbCrLf & _
...
Public Sub DoCloseActions(ByVal index As Integer)
 ...
 ' #End If
  ...
  'targetLenght(Index) = 0
  cavebotEnabled(index) = False
  'targetEnabled(Index) = False
  ...
  RuneMakerOptions(index).autoUtamo = RuneMakerOptions_autoUtamo_default
  RuneMakerOptions(index).autotar = RuneMakerOptions_autotar_default
  RuneMakerOptions(index).autoAp = RuneMakerOptions_autoAp_default
  RuneMakerOptions(index).autossa = RuneMakerOptions_autossa_default
  RuneMakerOptions(index).autopmax = RuneMakerOptions_autopmax_default
  RuneMakerOptions(index).autoSdt = RuneMakerOptions_autoSdt_default
  RuneMakerOptions(index).autoDan = RuneMakerOptions_autoDan_default
  RuneMakerOptions(index).autodd = RuneMakerOptions_autodd_default
  RuneMakerOptions(index).autoee = RuneMakerOptions_autoee_default
  RuneMakerOptions(index).autoarme4 = RuneMakerOptions_autoarme4_default
  RuneMakerOptions(index).autoarme5 = RuneMakerOptions_autoarme5_default
  RuneMakerOptions(index).autoarme6 = RuneMakerOptions_autoarme6_default
  RuneMakerOptions(index).autora = RuneMakerOptions_autora_default
  RuneMakerOptions(index).autoda = RuneMakerOptions_autoda_default
  RuneMakerOptions(index).autoxray = RuneMakerOptions_autoxray_default
  RuneMakerOptions(index).autodk = RuneMakerOptions_autodk_default
  RuneMakerOptions(index).autogHur = RuneMakerOptions_autogHur_default
  RuneMakerOptions(index).autoHur = RuneMakerOptions_autoHur_default
  RuneMakerOptions(index).autoPM2 = RuneMakerOptions_autoPM2_default
  RuneMakerOptions(index).autoaim = RuneMakerOptions_autoaim_default
  RuneMakerOptions(index).autoUE = RuneMakerOptions_autoUE_default
  RuneMakerOptions(index).locktrigger = RuneMakerOptions_locktrigger_default
  ...
  RuneMakerOptions(index).autossap = RuneMakerOptions_autossap_default
  RuneMakerOptions(index).autoerg = RuneMakerOptions_autoerg_default
  ...
  RuneMakerOptions(index).cmbleaderText = RuneMakerOptions_cmbleaderText_default
  RuneMakerOptions(index).comboText = RuneMakerOptions_comboText_default
  RuneMakerOptions(index).synccomboText = RuneMakerOptions_synccomboText_default
  RuneMakerOptions(index).cmbtypeText = RuneMakerOptions_cmbtypeText_default
  RuneMakerOptions(index).thirdActionText = RuneMakerOptions_thirdActionText_default
  RuneMakerOptions(index).firstActionMana = RuneMakerOptions_firstActionMana_default
  RuneMakerOptions(index).beeploot = RuneMakerOptions_beeploot_default
  RuneMakerOptions(index).Text2 = RuneMakerOptions_text2_default
  RuneMakerOptions(index).Text3 = RuneMakerOptions_text3_default
...
HardcoreCheatsOptions(index).Text11 = HardcoreCheatsOptions_Text11_default
HardcoreCheatsOptions(index).Text10 = HardcoreCheatsOptions_Text10_default
HardcoreCheatsOptions(index).Text7 = HardcoreCheatsOptions_Text7_default
HardcoreCheatsOptions(index).Text8 = HardcoreCheatsOptions_Text8_default
HardcoreCheatsOptions(index).Text2 = HardcoreCheatsOptions_Text2_default
HardcoreCheatsOptions(index).Text3 = HardcoreCheatsOptions_Text3_default
HardcoreCheatsOptions(index).Text12 = HardcoreCheatsOptions_Text12_default
HardcoreCheatsOptions(index).Text3 = HardcoreCheatsOptions_Text3_default
HardcoreCheatsOptions(index).Text6 = HardcoreCheatsOptions_Text6_default
HardcoreCheatsOptions(index).Text5 = HardcoreCheatsOptions_Text5_default
HardcoreCheatsOptions(index).txtExuraVita = HardcoreCheatsOptions_txtExuraVita_default
HardcoreCheatsOptions(index).txtExuraVita2 = HardcoreCheatsOptions_txtExuraVita2_default
HardcoreCheatsOptions(index).txtExuraVitaMana2 = HardcoreCheatsOptions_txtExuraVitaMana2_default
HardcoreCheatsOptions(index).txtExuraVitaMana = HardcoreCheatsOptions_txtExuraVitaMana_default
HardcoreCheatsOptions(index).txtExuraVita4 = HardcoreCheatsOptions_txtExuraVita4_default
HardcoreCheatsOptions(index).txtExuraVita3 = HardcoreCheatsOptions_txtExuraVita3_default
HardcoreCheatsOptions(index).arme = HardcoreCheatsOptions_arme_default
HardcoreCheatsOptions(index).arme2 = HardcoreCheatsOptions_arme2_default
HardcoreCheatsOptions(index).arme3 = HardcoreCheatsOptions_arme3_default
HardcoreCheatsOptions(index).sphi = HardcoreCheatsOptions_sphi_default
HardcoreCheatsOptions(index).splo = HardcoreCheatsOptions_splo_default
HardcoreCheatsOptions(index).pmh = HardcoreCheatsOptions_pmh_default
HardcoreCheatsOptions(index).pth = HardcoreCheatsOptions_pth_default
  ...
  frmHardcoreCheats.LoadHardcoreCheatsChars
...
ReDim DoingNewLootMAXGTC(1 To MAXCLIENTS)
  ...
  ReDim HardcoreCheatsOptions(1 To MAXCLIENTS)
  ...
  Exit Function
goterr:
  MsgBox "Sorry, " & currentAppName & " was not able to read .ini files (start)" & vbCrLf & "Possible reasons:" & vbCrLf & _
...
'  End If
  ...
  strInfo = Left(strInfo, i)
  If strInfo = "0" Then
    frmRunemaker.chkReveal.Value = 0
  Else
    frmRunemaker.chkReveal.Value = 1
  End If
  ...
  'tentativa validacao
  '  strInfo = String$(10, 0)
  'i = getBlackdINI("Cheats", "Text2", "", strInfo, Len(strInfo), here)
  'If i > 0 Then
  '  strInfo = Left(strInfo, i)
  '  lonInfo = CLng(strInfo)
  '  Text2 = lonInfo
  '  frmHardcoreCheats.Text2.Text = CStr(Text2)
  'Else
  '  Text2 = 0
  '  frmHardcoreCheats.Text2.Text = CStr(Text2)
  'End If
  ...
  Else
    frmWarbot.txtAutohealDelay.Text = "200"
    frmWarbot.timerFriendHealer.Interval = 200
  End If
  ...
  Else
    frmWarbot.txtAutohealDelay2.Text = "200"
...
frmRunemaker.txrRunemakerChaos2.Text = CStr(RunemakerChaos2)
  ...
  If i > 0 Then
    ...
    If TrialVersion = True Then
      frmMain.Caption = currentAppName & " " & ProxyVersion & " TRIAL"
    End If
  Else
   frmMain.Caption = currentAppName & " " & ProxyVersion
    If TrialVersion = True Then
      frmMain.Caption = currentAppName & " " & ProxyVersion & " TRIAL"
    End If
  End If
  ...
  Exit Sub
goterr:
  MsgBox "Sorry, " & currentAppName & " was not able to read ini files (end)" & vbCrLf & "Possible reasons:" & vbCrLf & _
  " - Corrupted config.ini" & vbCrLf & _
  " - Corrupted settings.ini" & vbCrLf & _
  " Details:" & vbCrLf & _
  " - Error number " & Err.Number & vbCrLf & _
...
'  i = setBlackdINI("MemoryAddresses", "adrAccount", strInfo, here)
 ...
 'chkLogoutIfDanger
  ...
  'chkReveal
  strInfo = CStr(frmRunemaker.chkReveal.Value)
    ...
    If useID > 0 Then
        ...
        If frmMain.chkBlockRemote.Value = 1 Then
            If Left$(strFrom, 8) <> "127.0.0." Then
                txtPackets.Text = txtPackets.Text & vbCrLf & "ALARM: Remote connection detected from " & SckClient(useID).RemoteHostIP & " ( " & SckClient(useID).RemoteHost & " ) to port " & CStr(SckClient(useID).RemotePort) & " It have been blocked. Please block your " & currentAppName & " ports in your router or firewall for higher security."
                'ChangePlayTheDangerSound True
                SckClient(useID).Close
                DoEvents
                Exit Sub
  ...
  If useID > 0 Then
    ...
    If frmMain.chkBlockRemote.Value = 1 Then
      ...
      If Left$(strRemoteIP, 8) <> "127.0.0." Then
        txtPackets.Text = txtPackets.Text & vbCrLf & "ALARM: Remote connection detected from " & sckClientGame(useID).RemoteHostIP & " ( " & sckClientGame(useID).RemoteHost & " ) to port " & CStr(sckClientGame(useID).RemotePort) & " It have been blocked. Please block your " & currentAppName & " ports in your router or firewall for higher security."
        'ChangePlayTheDangerSound True
        sckClientGame(useID).Close
        DoEvents
        Exit Sub
...
'ok:
     ...
     Else
      ...
      ' RecordLoginOnFile CharacterList2(tmpID).item(listPos).CharacterName, buildIPstring(CInt(CharacterList2(tmpID).item(listPos).serverIP1), _
       ...
       If TibiaVersionLong >= 1011 Then
        txtPackets.Text = txtPackets.Text & vbCrLf & "#the client ID " & tmpID & " selected the character " & _
          CharacterList2(tmpID).item(listPos).CharacterName & " - forwarding connection to " & tibiaEntryServer & ":" & _
  ...
  If sckServerGame(index).State <> sckConnected Then
    ...
    Else
      If (PlayTheDangerSound = False) Then
        'ChangePlayTheDangerSound False
        pres = GiveGMmessage(index, "The connection with the server was lost", currentAppName)
        DoEvents
        frmMain.txtPackets.Text = frmMain.txtPackets.Text & vbCrLf & "The connection with the server have been lost on client #" & CStr(index)
      End If
    End If
...
Private Sub TimerChanger_Timer()
If TrueServer3.Value = True Then
LastNumTibiaClients = 0
'      If chckAlter = False Then
'      frmMain.chckAlter.Value = 1
'      Else
'      frmMain.chckAlter.Value = 0
'      End If
      If chckMemoryIP = False Then
      frmMain.chckMemoryIP.Value = 1
      Else
      frmMain.chckMemoryIP.Value = 0
      End If
End If
End Sub
...
If TimerChanger.enabled = False Then
TimerChanger.enabled = True
End If
...
Private Sub txtClientLoginP_Validate(Cancel As Boolean)
  ...
  Exit Sub
goterr:
  MsgBox "Sorry, " & currentAppName & " was not able to initialize..." & vbCrLf & "Possible reasons:" & vbCrLf & _
  " - " & currentAppName & " already open" & vbCrLf & _
...
Private Function GetWITHTIBIADAT() As String
    ...
    If fso.FolderExists(usethisfolder) = False Then
        ...
        "Reload " & currentAppName & " and select a correct folder", vbCritical + vbOKOnly, currentAppName & " - Config Error"
        SaveConfigWizard True
        End
    End If
