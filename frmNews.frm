...
Private Sub Form_Load()
    Dim strMsg As String
     strMsg = "Blackd Proxy NG 5.8" & vbCrLf & _
    "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.93"
     
     strMsg = strMsg & vbCrLf & "Blackd Proxy NG 5.7" & vbCrLf & _
    "----------------------------" & vbCrLf & _
    ...
    "----------------------------" & vbCrLf & _
     ...
     strMsg = strMsg & vbCrLf & "Blackd Proxy NG 5.5" & vbCrLf & _
    "----------------------------" & vbCrLf & _
    ...
    "----------------------------" & vbCrLf & _
     ...
     strMsg = strMsg & vbCrLf & "Blackd Proxy NG 5.1" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.91"

     strMsg = strMsg & vbCrLf & "Blackd Proxy NG 5.0" & vbCrLf & _
     "----------------------------" & vbCrLf & _
    ...
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 3.4" & vbCrLf & _
     "----------------------------" & vbCrLf & _
    ...
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 3.1" & vbCrLf & _
     "----------------------------" & vbCrLf & _
    ...
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 3.0" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Fixed a bug with mc caveboting. Sorry for taking so much time."
     
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 2.9" & vbCrLf & _
     "----------------------------" & vbCrLf & _
    ...
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 2.8" & vbCrLf & _
     "----------------------------" & vbCrLf & _
    ...
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 2.7" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.72"
     
    strMsg = strMsg & vbCrLf & "Blackd Proxy NG 2.6" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.71"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 2.5" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Fixed a bug with guild channels at Tibia 10.70" & vbCrLf & _
     " - Fixed a bug with party invites at Tibia 10.70"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 2.4" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.70"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 2.3" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.64"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 2.2" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.63"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 2.1" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.62"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 2.0" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.61"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.9" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.60"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.8" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Fixed a bug with speed at Tibia 10.59"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.7" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Now compatible with all Tibia versions up to 10.59" & vbCrLf & _
     " - Added conditions" & vbCrLf & _
     " - Added alarm when msg appear" & vbCrLf & _
     " - Added MC tools" & vbCrLf & _
     " - Fixed auto utamo" & vbCrLf & _
     " - Fixed PM alarm" & vbCrLf & _
     " - Fixed retry attack" & vbCrLf & _
     " - Some small changes"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.6" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.58"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.5" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Added Aimbot feature." & vbCrLf & _
     " - Fixed UI colors and sizes." & vbCrLf & _
     " - Fixed bug with mana validation." & vbCrLf & _
     " - Fixed arrow refill."
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.4" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.57"
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.3" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Fixed a  bug with Tibia 10.56"
    
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.2" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - We improved anti detection systems a bit." & vbCrLf & _
     " - Minimum changes to work in all Tibia versions up to 10.56"
      
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.1" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Fixed a remaining bug with Tibia 10.55" & vbCrLf & _
     " - StopOnGamemaster feature is now disabled by default. It does not make much sense nowadays and it gives problems in some OT servers. However it can be optionally reenabled in Config menu."
     
    strMsg = strMsg & vbCrLf & vbCrLf & "Blackd Proxy NG 1.0 !!" & vbCrLf & _
     "----------------------------" & vbCrLf & _
     " - Too many changes :) We will try to write a new tutorial soon."
...
'    cmdOk2.Top = frmNews.ScaleHeight - 480
'  End If
End Sub
