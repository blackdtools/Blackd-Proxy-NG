...
Public Function LoadDatFile740(ByVal tibiadathere As String) As Integer
  ...
  #If TileDebug = 1 Then
    OverwriteOnFile "tibiadatdebug.txt", "Here is what " & currentAppName & " could read in your tibia.dat file :"
  #End If
...
Public Function LoadDatFile4(ByVal tibiadathere As String) As Integer
  ...
  #End If
  res = 0
  tileOnDebug = 20000 ' last debug done at tile 2110
...
Public Function LoadDatFile9(ByVal tibiadathere As String) As Integer
  ...
  #End If
  res = 0
  tileOnDebug = 30000 ' last debug done at tile 2110
